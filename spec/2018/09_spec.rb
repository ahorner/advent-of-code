...
describe "Day 9: Marble Mania" do
  ...
  describe "Part One" do
    it "calculates high scores for marble rounds" do
      ...
      expect(runner.execute!("13 players; last marble is worth 7999 points", part: 1)).to eq(146373)
      expect(runner.execute!("17 players; last marble is worth 1104 points", part: 1)).to eq(2764)
      expect(runner.execute!("21 players; last marble is worth 6111 points", part: 1)).to eq(54718)
      expect(runner.execute!("30 players; last marble is worth 5807 points", part: 1)).to eq(37305)
    end
  end
end
